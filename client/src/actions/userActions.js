...
import { LOGIN_REQUEST, LOGIN_SUCCESS, LOGIN_FAIL, REGISTER_SUCCESS, REGISTER_REQUEST, REGISTER_FAIL, CLEAR_ERRORS, LOAD_USER_REQUEST, LOAD_USER_SUCCESS, LOAD_USER_FAIL, LOGOUT_SUCCESS, LOGOUT_FAIL, UPDATE_PROFILE_FAIL, UPDATE_PROFILE_REQUEST, UPDATE_PROFILE_SUCCESS, UPDATE_PASSWORD_FAIL, UPDATE_PASSWORD_REQUEST, UPDATE_PASSWORD_SUCCESS, FORGOT_PASSWORD_FAIL, FORGOT_PASSWORD_REQUEST, FORGOT_PASSWORD_SUCCESS, RESET_PASSWORD_REQUEST, RESET_PASSWORD_SUCCESS, RESET_PASSWORD_FAIL, ALL_USERS_REQUEST, ALL_USERS_FAIL, ALL_USERS_SUCCESS, DELETE_USER_REQUEST, DELETE_USER_SUCCESS, DELETE_USER_FAIL, UPDATE_USER_REQUEST, UPDATE_USER_SUCCESS, UPDATE_USER_FAIL, USER_DETAILS_REQUEST, USER_DETAILS_SUCCESS, USER_DETAILS_FAIL } from '../constants/userConstants.js';
...
export const updateProfile = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put('/users/profile/update', userData, config);
...
export const updatePassword = (password) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put('/users/password/update', password, config);
...
export const updateUser = (id, userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/users/admin/profile/update/${id}`, userData, config);
...
export const deleteUser = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`/users/admin/delete/${id}`);
