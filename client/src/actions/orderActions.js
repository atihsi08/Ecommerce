import { CREATE_ORDER_SUCCESS, CREATE_ORDER_FAIL, CREATE_ORDER_REQUEST, MY_ORDERS_REQUEST, MY_ORDERS_SUCCESS, MY_ORDERS_FAIL, ORDER_DETAILS_REQUEST, ORDER_DETAILS_SUCCESS, ORDER_DETAILS_FAIL, ALL_ORDERS_SUCCESS, ALL_ORDERS_FAIL, ALL_ORDERS_REQUEST, UPDATE_ORDER_REQUEST, UPDATE_ORDER_SUCCESS, UPDATE_ORDER_FAIL, DELETE_ORDER_REQUEST, DELETE_ORDER_SUCCESS, DELETE_ORDER_FAIL, CLEAR_ERRORS } from '../constants/orderConstants.js';
...
export const updateOrder = (id, orderData) => async (dispatch) => {
    try {
        ...
        const config = { headers: { "Content-Type": "application/json" } };
        const { data } = await axios.put(`/orders/update/${id}`, orderData, config);
